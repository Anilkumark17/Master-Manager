...
export function PrdWorkspace({ projectId, project }) {
  ...
  return (
    <div className="space-y-8">
      <AiCallout title="OpenRouter + product journey">
        This tab loads your{" "}
        ...
        <code className="rounded bg-muted px-1">OPENROUTER_MODEL</code>. Plain
                    ...
                    <div className="space-y-4 border-t border-border/60 px-3 py-3">
                      ...
                      {sec.id === "strategicRollout" ? (
                        <div className="space-y-2 border-t border-border/60 pt-4">
                          ...
                          <p className="text-[11px] text-muted-foreground">
                            Uses the same OpenRouter key as other AI actions.
