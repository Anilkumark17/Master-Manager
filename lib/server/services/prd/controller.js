...
import { chat, getModel } from "@/lib/server/services/prd/openrouterClient";
import {
  getFormFillSystemPrompt,
  buildUserMessageFormFill,
  parseModelFormJson,
} from "@/lib/server/services/prd/prdTemplate";
import {
  STRATEGIC_ROLLOUT_SYSTEM,
  buildStrategicRolloutUserMessage,
} from "@/lib/server/services/prd/strategicRolloutPrompt";
...
export { list, getOne, create, patch, generate, strategicRollout };
