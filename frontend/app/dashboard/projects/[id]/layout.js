    ...
    return (
      <div className="flex min-h-full flex-col bg-background">
        ...
        <main className="space-y-2 p-6 text-sm text-muted-foreground">
          <p>Unable to load this workspace — the app could not reach the API.</p>
          <p className="text-xs">
            Start the backend (port 5000 by default) and set{" "}
            ...
            (for example <code className="rounded bg-muted px-1 py-0.5 text-foreground">http://127.0.0.1:5000</code> on
            Windows).
          </p>
        </main>
      </div>
